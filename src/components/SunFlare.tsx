...
// up from earlier values that all felt too short; at 11s the fall
// has proper room to breathe, still well short of the original 82
// (which lingered ~55s into the sun's descent).
const FLARE_WINDOW_END = 53;
