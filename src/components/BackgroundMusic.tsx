...
/**
 * Gymnopédie No.1 as the ambient layer of the ritual. Browsers won't
 * play audio without a user gesture, so this component does nothing
 * until `play` flips true (which Scene wires to the moment the user
 * taps). The piano then fades in over 1.5s — the wisp is just landing
 * on the earth, the first chord arrives with the ignition.
 *
 * The mute toggle:
